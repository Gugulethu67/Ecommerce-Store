		...
		>
			...
			>
				...
				>
					...
					>
						We are committed to providing high-quality products and excellent customer service. Our goal is to create a seamless shopping experience for our customers.
					</Typography>
					<Stack
						direction={"row"}
						alignItems={"center"}
